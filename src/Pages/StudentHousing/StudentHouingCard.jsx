...
const StudentHouingCard = ({ studentHouse }) => {

    const { estate_title, description, id, area, price, status, image } = studentHouse
        ...
        <div>
            <div className="card bg-base-100 shadow-xl">
                ...
                <div className="card-body">
                    ...
                    <div className="">
                        <Link to={`/studentHouse/${id}`}><button className="btn w-full btn-primary">View Property</button></Link>
                    </div>
                </div>
            </div>
        </div>
...
export default StudentHouingCard;